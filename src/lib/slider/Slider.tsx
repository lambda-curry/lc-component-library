...
import { Slider as MuiSlider, SliderProps, SliderTypeMap } from '@material-ui/core';
import classNames from 'classnames';
import { FormikProps } from 'formik';

export const Slider: React.FC<
  SliderProps<SliderTypeMap['defaultComponent']> & {
    name: string;
    label?: string;
    formikProps: FormikProps<any>;
  }
> = ({ id, name, valueLabelDisplay = 'auto', label, className, onChange, formikProps, value, ...sliderProps }) => {
