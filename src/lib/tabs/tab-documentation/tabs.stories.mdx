...
<Canvas>
  ...
  <Story
    name="Paragraph with Span as Tab Label"
    parameters={{
      docs: {
        source: {
          code: dedent`
        ...
        tabs={[
          {
            label: (
              <p>
                Test 1 <span style={{ color: 'green' }}>Check it out</span>
              </p>
            ),
            render: '1'
          }
  ...
  >
    <div className="tabs-story">
      <Tabs
        initialValue="3"
        tabs={[
          { label: <p>Test 1</p>, render: '1', value: '1' },
          { label: <p>Test 2</p>, render: '2', value: '2' },
          { label: <p>Test 3</p>, render: '3', value: '3' },
          { label: <p>Test 4</p>, render: '4', value: '4' }
        ]}
      />
    </div>
  </Story>
