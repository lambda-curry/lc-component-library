...
const themeColorsConfig = {
  gray: ['lightest', 'lighter', 'light', 'DEFAULT', 'dark', 'darker'],
...
const generateVariantThemeColors = colorName =>
  themeColorsConfig[colorName].reduce((acc, variantColorName) => {
...
const generateThemeColors = () =>
  Object.keys(themeColorsConfig).reduce((acc, colorName) => {
