import React, { FC, ReactNode, HTMLAttributes, PropsWithChildren } from 'react';
...
export const ModalHeader: FC<PropsWithChildren<ModalHeaderProps>> = ({ title, className, children, ...props }) => (
