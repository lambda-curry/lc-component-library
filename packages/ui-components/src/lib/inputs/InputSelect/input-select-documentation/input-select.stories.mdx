            ...
            {formikProps => {
              return (
                <>
                  ...
                  />
                  <div className="lc-p-16 lc-bg-gray-dark lc-text-white">
          ...
          return (
            <>
              ...
              <InputSelect
                ...
                formikProps={formikProps}
              />
              <div className="lc-p-16 lc-mb-24 lc-bg-gray-dark lc-text-white">
                <p className="lc-mb-8">Value: {JSON.stringify(formikProps.values.select_gray_bg)}</p>
                <InputSelect
                  labelPlacement="above"
                  label="Select Option"
          ...
          <Form enableReinitialize={true} initialValues={{ customValue: undefined }} onSubmit={() => {}}>
            {formikProps => {
              return (
                <>
                  <ButtonOutline onClick={() => formikProps.resetForm()}>Reset</ButtonOutline>
                  <p className="lc-my-8">Value: {JSON.stringify(formikProps.values.customValue)}</p>
                  <InputSelect
                    label="Select Custom Value"
                    name="customValue"
                    optionValueKey="value"
          ...
          <Form enableReinitialize={true} initialValues={{ multiselect: [] }} onSubmit={() => {}}>
            {formikProps => {
              return (
                <>
                  <ButtonOutline onClick={() => formikProps.resetForm()}>Reset</ButtonOutline>
                  <p className="lc-my-8">Value: {JSON.stringify(formikProps.values.multiselect)}</p>
                  <InputSelect
                    label="Multiselect input"
                    name="multiselect"
                    optionValueKey="value"
