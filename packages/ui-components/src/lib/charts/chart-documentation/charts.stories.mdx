...
Note: Charts have a dependency on Chart.js and Moment. We help with tree shaking by only including this component at `/lib/charts`
`import { PieChart } from @lambdacurry/component-library/lib/charts;`
